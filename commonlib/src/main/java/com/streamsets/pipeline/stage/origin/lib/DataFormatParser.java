    ...
    switch (dataFormat) {
      ...
      case DELIMITED:
        builder.setMaxDataLen(dataFormatConfig.csvMaxObjectLen)
          ...
          .setConfig(DelimitedDataConstants.ESCAPE_CONFIG, dataFormatConfig.useCsvCustomEscape ? dataFormatConfig.csvCustomEscape : null)
          .setConfig(DelimitedDataConstants.QUOTE_CONFIG, dataFormatConfig.useCsvCustomQuote ? dataFormatConfig.csvCustomQuote : null)
