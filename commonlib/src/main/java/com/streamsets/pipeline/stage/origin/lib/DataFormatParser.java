    ...
    switch (dataFormat) {
      ...
      case DELIMITED:
        builder.setMaxDataLen(dataFormatConfig.csvMaxObjectLen)
          ...
          .setConfig(DelimitedDataConstants.ESCAPE_ENABLED_CONFIG, dataFormatConfig.useCsvCustomEscape)
          .setConfig(DelimitedDataConstants.ESCAPE_CONFIG, dataFormatConfig.csvCustomEscape)
          .setConfig(DelimitedDataConstants.QUOTE_ENABLED_CONFIG, dataFormatConfig.useCsvCustomQuote)
